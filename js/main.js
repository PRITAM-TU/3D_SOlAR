...
function createMaterialArray() {
  const skyboxImagepaths = ['../image/skybox/space_ft.png', '../image/skybox/space_bk.png', '../image/skybox/space_up.png', '../image/skybox/space_dn.png', '../image/skybox/space_rt.png', '../image/skybox/space_lf.png']
...
function init() {
  ...
  setSkyBox();
  planet_earth = loadPlanetTexture("../image/earth_hd.jpg", 4, 100, 100, 'standard');
  planet_sun = loadPlanetTexture("../image/sun_hd.jpg", 20, 100, 100, 'basic');
  planet_mercury = loadPlanetTexture("../image/mercury_hd.jpg", 2, 100, 100, 'standard');
  planet_venus = loadPlanetTexture("../image/venus_hd.jpg", 3, 100, 100, 'standard');
  planet_mars = loadPlanetTexture("../image/mars_hd.jpg", 3.5, 100, 100, 'standard');
  planet_jupiter = loadPlanetTexture("../image/jupiter_hd.jpg", 10, 100, 100, 'standard');
  planet_saturn = loadPlanetTexture("../image/saturn_hd.jpg", 8, 100, 100, 'standard');
  planet_uranus = loadPlanetTexture("../image/uranus_hd.jpg", 6, 100, 100, 'standard');
  planet_neptune = loadPlanetTexture("../image/neptune_hd.jpg", 5, 100, 100, 'standard');
